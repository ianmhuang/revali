...
class SplitTests(unittest.TestCase):
    def test_non_blocking_split(self):
        data = approve_response(findings=[F_HIGH, F_LOW, F_MEDCONV, finding("F4", "medium", "security"),
...
class ChangesRequestedTests(RepoCase):
    ...
    def test_nothing_changed_message_unchanged(self):
        self.claude(claude_entry(approve_response(verdict="CHANGES_REQUESTED", findings=[F_HIGH, F_LOW])))
